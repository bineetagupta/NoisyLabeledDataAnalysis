...
class noisyLblPerceptronCust():


    def calcPreceptronCust(self,X_train, X_test, y_train, y_test, file_nm, rho_pos_val, rho_neg_val):
        ...
        clf = Perceptron(n_iterations=5000,
            ...
            rho_pos = rho_pos_val, rho_neg = rho_neg_val)
